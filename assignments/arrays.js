...
let lastCar = 0;
console.log(`The last car in inventory is a ${inventory[49].car_make} ${inventory[49].car_model}` );
...
console.log("This is all of the BMW and Audi cars in the lot: " + JSON.stringify(BMWAndAudi));
